...
<div class="container">
    <div class="card-body">
        <div class="container" style="border: 1px solid; border-color: green; padding: 10px; border-radius: 70px 20px;">
            ...
            <hr/>
            <hr/>
            <form action="{{ asset('/Aula/notificationAlUpdate/' . $aula->id) }}" method="post" class="col-md-6" enctype="multipart/form-data">
                {{ csrf_field() }}
            ...
            <hr/>
            <hr/>
            <a class="btn btn-primary" href="/Aula/list" role="button">Regresar</a>
        </div>
    </div>
</div>
@endsection