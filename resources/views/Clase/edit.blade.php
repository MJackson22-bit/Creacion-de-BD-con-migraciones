...
<div class="container">
    <div class="card-body">
        <div class="container" style="border: 1px solid; border-color: green; padding: 10px; border-radius: 70px 20px;">
            ...
            <form action="{{ asset('/Clase/notificationClaUpdate/' . $clase->codclase) }}" method="post" class="col-md-6" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="form-group">
                    <label for="c_codigo"><h5><strong>Codigo de la clase (No Editable)</strong></h5></label>
                    <input type="text" id="c_codigo" class="form-control col-md-6" name="c_codigo" readonly value="{{$clase->codclase}}"  required>
                </div>
                <br/>
                <div class="form-group">
                ...
                <br/>
                <button type="submit" name="btEnviar" value="btPersonaje" class="btn btn-primary">Actulizar</button>
            </form>
            <hr/>
            <hr/>
